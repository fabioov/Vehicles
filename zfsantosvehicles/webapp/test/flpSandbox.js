		...
		services: {
					...
					"config": {
						"groups": [{
							"tiles": [{
								...
								"properties": {
									"title": "Vehicles",
									"targetURL": "#vehicleszfsantosvehicles-display"
								}
							}]
						}]
					}
			...
			"ClientSideTargetResolution": {
				"adapter": {
					"config": {
						"inbounds": {
							"vehicleszfsantosvehicles-display": {
								"semanticObject": "vehicleszfsantosvehicles",
								"action": "display",
								...
								"resolutionResult": {
									...
									"additionalInformation": "SAPUI5.Component=vehicles.zfsantosvehicles",
									"url": sap.ui.require.toUrl("vehicles/zfsantosvehicles")
								}
							}
						}
					}
