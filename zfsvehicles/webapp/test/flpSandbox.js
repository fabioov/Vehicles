		...
		services: {
					...
					"config": {
						"groups": [{
							"tiles": [{
								...
								"properties": {
									"title": "Vehicles",
									"targetURL": "#vehicleszfsvehicles-display"
								}
							}]
						}]
					}
			...
			"ClientSideTargetResolution": {
				"adapter": {
					"config": {
						"inbounds": {
							"vehicleszfsvehicles-display": {
								"semanticObject": "vehicleszfsvehicles",
								"action": "display",
								...
								"resolutionResult": {
									...
									"additionalInformation": "SAPUI5.Component=vehicles.zfsvehicles",
									"url": sap.ui.require.toUrl("vehicles/zfsvehicles")
								}
							}
						}
					}
